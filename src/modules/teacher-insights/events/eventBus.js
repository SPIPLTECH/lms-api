  ...
  subscribe(eventName, handler) {
    const safeHandler = (payload) => {
      try {
        ...
        console.error(`[teacher-insights:eventBus] subscriber threw on "${eventName}":`, error);
      }
    };
...
const teacherInsightBus = new TeacherInsightEventBus();

module.exports = { teacherInsightBus, TeacherInsightEventBus };

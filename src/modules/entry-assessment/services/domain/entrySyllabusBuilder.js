 ...
 * course "syllabus" — one concept per published module. Also returns each
 * module's total estimated minutes, later used as the "original duration"
 * baseline for Smart Revision / Deep Learning time compression.
 *

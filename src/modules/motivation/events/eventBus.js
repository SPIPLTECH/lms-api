  ...
  subscribe(eventName, handler) {
    const safeHandler = (payload) => {
      try {
        ...
        console.error(`[motivation:eventBus] subscriber threw on "${eventName}":`, error);
      }
    };
...
const motivationBus = new MotivationEventBus();

module.exports = { motivationBus, MotivationEventBus };

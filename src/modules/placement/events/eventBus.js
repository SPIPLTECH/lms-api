  ...
  subscribe(eventName, handler) {
    const safeHandler = (payload) => {
      try {
        ...
        console.error(`[placement:eventBus] subscriber threw on "${eventName}":`, error);
      }
    };
...
const placementBus = new PlacementEventBus();

module.exports = { placementBus, PlacementEventBus };

  ...
  subscribe(eventName, handler) {
    const safeHandler = (payload) => {
      try {
        ...
        console.error(`[recommendation:eventBus] subscriber threw on "${eventName}":`, error);
      }
    };
...
const recommendationBus = new RecommendationEventBus();

module.exports = { recommendationBus, RecommendationEventBus };

...
/**
 * Real LLM integration for entry-assessment question generation — own copy
 * of the Mentor Agent's llm/anthropicProvider.js (same "real adapter seam,
 * honest empty default" pattern), not a shared import, matching this
 * codebase's per-agent convention that each module's HTTP/LLM layer stays

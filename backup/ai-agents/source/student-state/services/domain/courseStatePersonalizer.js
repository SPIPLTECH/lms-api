...
/**
 * Builds the full per-course personalization payload from the Assessment
 * Agent's evaluated concept scores: real per-module durations (Deliverable
 * #5's "Recommended Learning Time for every concept"), plus the aggregate
 * totals the dashboard needs (Deliverable #8's "Time Saved Through AI
 * Personalization").
 *

...
/**
 * @param {Object} report - DTO-shaped report entry (see dto/adminIntelligenceResponse.dto.js#toReportEntry).
...
const exportReport = (report, format) => {
  ...
  return {
    ...
    filename: `admin-intelligence-report-${report.reportType.toLowerCase()}-${datePart}.${format.toLowerCase()}`,
  };
};

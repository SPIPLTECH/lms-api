  ...
  subscribe(eventName, handler) {
    const safeHandler = (payload) => {
      try {
        ...
        console.error(`[analytics:eventBus] subscriber threw on "${eventName}":`, error);
      }
    };
...
const analyticsBus = new AnalyticsEventBus();

module.exports = { analyticsBus, AnalyticsEventBus };
